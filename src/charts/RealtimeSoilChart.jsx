...
function RealtimeSoilChart({
      ...
      options: {
        ...
        scales: {
          y: {
            ...
            suggestedMin: 0, // Độ ẩm đất không thể âm
            suggestedMax: 100, // Độ ẩm đất tối đa 100%
            ticks: {
              maxTicksLimit: 5,
              callback: (value) => `${value}%`, // Thêm ký hiệu %
        ...
        plugins: {
          ...
          tooltip: {
            ...
            callbacks: {
              label: (context) => `${context.parsed.y}%`, // Hiển thị giá trị với %
            },
  ...
  useEffect(() => {
    ...
    // Hiển thị giá trị độ ẩm hiện tại
...
export default RealtimeSoilChart;
