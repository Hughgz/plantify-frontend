  ...
  return (
    <div className="relative inline-flex">
      ...
      >
        ...
        >
          <div className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase pt-1.5 pb-2 px-4">Thông báo</div>
          <ul>
            ...
            <li className="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">📢 <span className="font-medium text-gray-800 dark:text-gray-100">Hệ thống tưới cây tự động đã hoàn thành lịch trình!</span> Lượng nước tưới đạt ngưỡng theo yêu cầu.</span>
                <span className="block text-xs font-medium text-gray-400 dark:text-gray-500">1 giờ trước</span>
              </Link>
            </li>
            <li className="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">🌧 <span className="font-medium text-gray-800 dark:text-gray-100">Dự báo có mưa. Hệ thống sẽ tạm ngừng tưới cây.</span> Hãy kiểm tra lịch trình tưới.</span>
                <span className="block text-xs font-medium text-gray-400 dark:text-gray-500">2 giờ trước</span>
              </Link>
            </li>
            ...
            <li className="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">🔧 <span className="font-medium text-gray-800 dark:text-gray-100">Cảm biến độ ẩm gặp sự cố</span> Kiểm tra lại cảm biến.</span>
                <span className="block text-xs font-medium text-gray-400 dark:text-gray-500">30 phút trước</span>
              </Link>
            </li>
            <li className="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">⚠️ <span className="font-medium text-gray-800 dark:text-gray-100">Lượng nước tưới vượt mức giới hạn</span> Kiểm tra lại cấu hình hệ thống.</span>
                <span className="block text-xs font-medium text-gray-400 dark:text-gray-500">15 phút trước</span>
              </Link>
            </li>
          </ul>
        </div>
